...
In order to [personalize](ResponsiveEmail/json/personalization) the output it's possible to
...
POST call to the [/v1/template](ResponsiveEmail/api/post-template) method.
...
fetch the web version of an email, use the [/v1/template/{ID}/webversion](ResponsiveEmail/api/get-template-webversion) 
method instead.
