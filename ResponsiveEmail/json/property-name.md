...
The property [`name`](ResponsiveEmail/json/property-name) can 
be used to give the template a name. Both the [`name`](ResponsiveEmail/json/property-name) 
and the [`description`](ResponsiveEmail/json/property-description) 
are [top level properties](ResponsiveEmail/json/top-level-properties).
