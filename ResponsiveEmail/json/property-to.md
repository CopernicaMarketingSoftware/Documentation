...
All addressees of an email are set in the [`to`](ResponsiveEmail/json/property-to), [`cc`](ResponsiveEmail/json/property-cc) and [`bcc`](ResponsiveEmail/json/property-bcc)
