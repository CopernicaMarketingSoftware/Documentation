...
| [platforms](copernica-docs:ResponsiveEmail/json/property-follow-platforms) | _object_ | The platforms which we should be displaying in this follow block and their corresponding usernames/urls to follow.   |
