# REST API: GET subprofile data

Deze methode vraagt alle data beschikbaar voor een subprofiel op en geeft een 
JSON file terug. Om de data op te vragen kun je een HTTP GET verzoek sturen 
naar de volgende URL:

`https://api.copernica.com/v1/subprofile/$id/data?access_token=xxxx`
...
bevat die bekend is over dit subprofiel. Dit bestand bevat twee JSON 
