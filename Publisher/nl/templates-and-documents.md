...
dan het nieuwe systeem van de Marketing Suite. Als je een nieuwe gebruiker 
bent raden we dan ook aan om te beginnen met de [drag-and-drop editor](templates-marketing-suite) 
van de Marketing suite. Je moet zelf de HTML code van een
template schrijven en je moet zelf aangeven op welke plaatsen binnen de 
template variabele teksten en afbeeldingen kunnen worden geplaatst.

Bovendien wordt in de oude Publisher omgeving gebruik gemaakt van een 
gelaagd systeem: we maken onderscheid tussen *templates* en 
*documenten*. De template bepaalt de layout van de e-mail, zoals de plaats van 
...
Nadat een template is ontworpen, kun je op basis van die template 
...
Door dit template-en-documentsysteem hanteren veel Copernicagebruikers
...
* [Copernica syntax voor personalisatie](./personalization)
* [CSS en XSLT stylesheets](./css-and-xslt)
