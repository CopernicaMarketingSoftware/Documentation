# REST API: Opvragen van Marketing Suite template events

Als je gebeurtenissen van de afgelopen maandelijkse periode bij een Marketing
Suite template wilt downloaden, dan kun je die opvragen door middel van
een eenvoudige HTTP GET call naar de volgende URL
...
`https://api.copernica.com/v1/template/$id/events/$datum?access_token=xxxx`
