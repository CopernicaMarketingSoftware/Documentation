# REST API: GET emailings (Publisher document)
...
`https://api.copernica.com/v2/publisher/document/$id/emailings?access_token=xxxx`
...
* [Vraag een Publisher document op](./rest-get-publisher-document)
