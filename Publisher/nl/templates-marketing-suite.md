...
Headers worden gebruikt om informatie aan een email toe te voegen. Er zijn 
headers zoals "From" en "Subject" die gestandaardizeerd zijn, maar je kunt 
ook zogenaamde "x-headers" gebruiken om zelf te bepalen wat voor informatie 
je meestuurt. Zo voeg je zelf de informatie toe die jij nodig hebt, bijvoorbeeld 
voor het analyseren van resultaten van een campagne. Je kunt ook een BCC 
(Blind Carbon Copy) meesturen of de *List unsubscribe* header toevoegen. 
Zie ook het [artikel over headers](./headers).
