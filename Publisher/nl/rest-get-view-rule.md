...
- **inversed**: waarde die aangeeft of de regel een inverse is. 
Als deze variabele waar is worden profielen teruggegeven als ze de regel niet matchen
- **conditions**: array van voorwaarden voor de regel

Een regel heeft zijn eigen "conditions" (voorwaarden) waaraan voldaan moet worden 
...
De precieze eigenschappen hangen af van het type van de condition. 
...
print_r($api->get("view/{$view}/rule/{4regelID}"));
```
