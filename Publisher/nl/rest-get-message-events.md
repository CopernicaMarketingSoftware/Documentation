...
Als je gebeurtenissen bij een met Marketing Suite verstuurd bericht wilt
...
`https://api.copernica.com/v1/message/$id/events/$datum?access_token=xxxx`
...
Het volgende PHP script demonstreert hoe je de API methode kunt aanroepen.
    ...
    print_r($api->get("message/1sadf323/events"));
