...
Er zijn verschillende methodes toegankelijk via HTTP GET, POST, PUT en DELETE 
calls. De volgende kopjes bevatten een overzicht van methodes per object.
