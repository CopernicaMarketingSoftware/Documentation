...
| GET    | [api.copernica.com/v3/profile/$id/files](./rest-get-profile-files)                                   | Opvragen van alle files voor een profiel                          |
| GET    | [api.copernica.com/v3/profile/$id/file/$id/json](./rest-get-profile-file-json)                       | Opvragen van informatie van een file                              |
| GET    | [api.copernica.com/v3/profile/$id/file/$id/json](./rest-get-profile-file-content)                    | Opvragen van content van een file                                 |
...
| PUT    | [api.copernica.com/v3/publisher/document/$id/loopblock](./rest-put-publisher-document-loopblock)                | Bijwerken van loopblok in een document        |
| PUT    | [api.copernica.com/v3/publisher/document/$id/textblock](./rest-put-publisher-document-textblock)                | Bijwerken van textblok in een document        |
| PUT    | [api.copernica.com/v3/publisher/document/$id/imageblock](./rest-put-publisher-document-imageblock)              | Bijwerken van afbeeldingsblok in een document        |
