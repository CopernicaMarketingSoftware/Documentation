...
`https://api.copernica.com/v3/ms/message/$id/body?access_token=xxx`

of de volgende URL:

`https://api.copernica.com/v3/ms/message/$id/body/html?access_token=xxx`
...
`https://api.copernica.com/v3/ms/message/$id/body/mime?access_token=xxx`
...
`https://api.copernica.com/v3/ms/message/$id/body/text?access_token=xxx`
