# REST API: toevoegen van een regel aan een selectie.
...
* [Aanmaken van een nieuwe selectie](rest-put-view)
* [Toevoegen van condities aan een regel](rest-post-rule-conditions)
* [Selectie regels opvragen](rest-get-view-rules)
