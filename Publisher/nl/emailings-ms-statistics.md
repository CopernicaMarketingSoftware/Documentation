...
De statistieken kunnen bekeken worden via het **Mailings** menu. Klik vervolgens een mailing aan om de statistieken hiervan te bekijken. De volgende statistieken worden weergegeven. 


- **Totaal aantal berichten:** Het totaal aantal berichten dat gemiddeld genomen
per dag is verstuurd met het template.
...
Per categorie kan er ook een CSV gemaakt worden, in deze CSV staan de tijdstippen en profielen die de actie hebben gedaan. Klik op CSV downloaden om deze klaar te zetten. 
