...
| HTTP                                 | Hypertext Transfer Protocol: Standaard internetprotocol voor het versturen van informatie.                                                                                                           |
| HTTPS                                | Hypertext Transfer Protocol Secure: Veiligere en nieuwere versie van HTTPS. Gebruikt SSL voor encryptie van informatie.                                                                              |
...
| SPF                                  | Sender Policy Framework: Zorgt ervoor dat Copernica mag mailen vanaf jouw emailadres in dit geval.                                                                                                   |
