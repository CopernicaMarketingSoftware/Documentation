...
Everything that passes through Copernica gets logged: deliveries, bounces,
clicks, opens - all these events are written to log files. These log
files are accessible through the [REST API](rest-api). Yet, if you
...
```text
https://api.copernica.com/v1/events/messageid/MESSAGEID
https://api.copernica.com/v1/events/email/EMAILADDRESS
https://api.copernica.com/v1/events/tamplate/TEMPLATE
https://api.copernica.com/v1/events/tags/TAG1;OPTIONALTAG2;OPTIONALTAG3
```
...
```text
https://api.copernica.com/v1/events/template/TEMPLATE
```
...
```text
https://api.copernica/v1/events/tags/TAG
```
...
```text
https://api.copernica.com/v1/events/tags/TAG1;TAG2;TAG3;...
```
