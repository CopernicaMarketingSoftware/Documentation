...
`https://api.copernica.com/v2/publisher/emailingdestination/$id/unsubscribes?access_token=xxxx`
...
// execute the call
print_r($api->get("publisher/emailingdestination/{$emailingDestinationID}/unsubscribes/"));
```
