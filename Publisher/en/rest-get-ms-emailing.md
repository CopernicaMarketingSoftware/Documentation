...
* **timestamp**: Array containing the timestamp, timezone type and timezone.
* **status**: Status of the mailing.
* **subject**: Subject of the mailing.
* **fromaddress**: The from address.
* **target**: Array containing information about the target of the mailing, including ID and type.
