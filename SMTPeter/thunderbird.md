...
![Account Settings](SMTPeter/Images/account_settings.png "Go to account settings")

In your account settings go to the Outgoing Server and press Add. A small 
popup window comes up: 

![Add SMTP server](SMTPeter/Images/add_smtp_server.png "Add SMTP server")

Here you have to fill out our SMTP settings and username: 

![SMTP settings](SMTPeter/Images/smtp_settings.png "Configure SMTP settings")
...
![Set SMTP server](SMTPeter/Images/set_smtp_server.png "Set SMTP server")
