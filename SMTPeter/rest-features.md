...
bounce management in your [SMTPeter dashboard](dashboard/bounce-management).
...
[documentation on the stats method](rest/stats "documentation on the stats method").
...
```
With these ids you can obtain information using the GET methods [text](rest/text "REST command text")
and [html](rest/html "REST command html")
