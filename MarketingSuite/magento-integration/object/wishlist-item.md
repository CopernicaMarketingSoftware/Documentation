...
| wishlist        | _[Wishlist](wishlist)                      		 | Wishlist that item is assigned to.                        |
| product         | _[Product](product)                 		         | The actual product.                                       |
| addedAt         | _string_                                                                                             | Date when item was added.                                 |
| webstore        | _[Webstore](webstore)		                         | Webstore in which item was added.                         |
