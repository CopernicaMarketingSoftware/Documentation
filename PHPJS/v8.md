...
to parse and execute the user supplied Javascript code. To install PHP-JS, you 
...
directory is created in your home directory. (When I did this I had the
...
the "fetch" command that can be used for downloading V8:
