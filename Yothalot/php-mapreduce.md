...
Instead of calling the [Yothalot\Job](Yothalot/php-job "Job") add
...
`Yothalot\Job` `add()` method, which is discussed in [Yothalot\Job](Yothalot/php-job "Yothalot\Job")
The third argument provides `map()` the information what to do with the mapped results.
This is a [Yothalot\Reducer](Yothalot/php-reducer "Yothalot\Reducer") object, which is a very simple
...
into one value. The third argument is a [Yothalot\Writer](Yothalot/php-writer "Yothalot\Writer") object with
...
Keep in mind however that you can [tune your job](Yothalot/tuning)
