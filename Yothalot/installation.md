...
information you can read the [Files on the Yothalot cluster](Yothalot/files "Files and paths")
documentation.
...
We have a special [configuration section](Yothalot/configuration)
...
file system can be found. See our special article about [setting up a local Yothalot environment](Yothalot/local-installation)
...
* [C++ API](Yothalot/cppapi)
* [PHP API](Yothalot/phpapi)

(Note that in order to use the PHP API you need to [install](Yothalot/php-install "PHP Extension Installation")
the Yothalot PHP extension first)

That is all there is. Your Yothalot cluster is ready to go. If you are curious on how
to use it you can have a look at our MapReduce [Hello world!](Yothalot/helloworld)
