...
After the installation of the [PHP API](Yothalot/php-install "PHP Extension Installation")
...
* [How to install the Yothalot PHP extension](Yothalot/php-install "PHP Extension Installation")


## Core classes and interfaces

To run a Yothalot mapreduce task you first have to write a class that implements
the [Yothalot\MapReduce](Yothalot/php-mapreduce "MapReduce")
...
[Yothalot\Connection](Yothalot/php-connection "Connection")
...
[Yothalot\Job](Yothalot/php-job "Job"). If you have this job you
...
for the job to be processed and retrieve some [results](Yothalot/php-result "Result")
...
you can implement a class using the [Yothalot\Race](Yothalot/php-race "Race")
interface instead of the [Yothalot\MapReduce](Yothalot/php-mapreduce "MapReduce")
...
do this by implementing the [Yothalot\Task](Yothalot/php-task "Task") interface.

* [Interface Yothalot\MapReduce](Yothalot/php-mapreduce "MapReduce")
* [Interface Yothalot\Race](Yothalot/php-race "Race")
* [Interface Yothalot\Task](Yothalot/php-task "Task")
* [Class Yothalot\Connection](Yothalot/php-connection "Connection")
* [Class Yothalot\Job](Yothalot/php-job "Job")
* [Class Yothalot\Result](Yothalot/php-result "Result")
* [Class Yothalot\RaceResult](Yothalot/php-raceresult "RaceResult")
* [Class Yothalot\TaskResult](Yothalot/php-taskresult "TaskResult")
...
The [Yothalot\Path](Yothalot/php-path "Path") class can be used
...
The [Yothalot\Input](Yothalot/php-input "Input") and
[Yothalot\Output](Yothalot/php-output "Output") classes allow you
to read and write files in the same [format](Yothalot/internalfiles "Internal File Format")
used internally by the Yothalot framework for intermediate result files.

* [Class Yothalot\Path](Yothalot/php-path "Path")
* [Class Yothalot\Input](Yothalot/php-input "Input")
* [Class Yothalot\Output](Yothalot/php-output "Output")
...
* [Class Yothalot\RaceResult](Yothalot/php-raceresult "RaceResult")
* [Class Yothalot\TaskResult](Yothalot/php-taskresult "TaskResult")
* [Class Yothalot\Record](Yothalot/record "Record")
* [Class Yothalot\Reducer](Yothalot/php-reducer "Reducer")
* [Class Yothalot\Result](Yothalot/php-result "Result")
* [Class Yothalot\Values](Yothalot/php-values "Values")
* [Class Yothalot\Writer](Yothalot/php-writer "Writer")
