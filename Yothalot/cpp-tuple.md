...
It is a container that can hold fields of type [Yothalot::Scalar](cpp-scalar).
...
an iterator pair and a constructor that reads [Yothalot::Records](cpp-record). 
You can use it like:
```cpp
/**
...
With `write()` you can write the tuple to a [Yothalot::Record](cpp-record).
You can use it like:
```cpp
/**
 *  create a tuple
