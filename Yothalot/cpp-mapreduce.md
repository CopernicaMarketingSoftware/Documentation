...
More information on these types is given in the [Yothalot Classes](cpp-classes)
documentation 
...
tuning parameters about which you can read in [tune your job](tuning).
...
[executable](cpp-program "Create a Yothalot program").
