...
[records](record "Record") that have a key as identifier
...
files too, you can use the [Yothalot\Input](php-input "Input")
and [Yothalot\Output](php-output "Output") utility classes.
