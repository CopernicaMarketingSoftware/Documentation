...
##Constructor
The constructo thakes one parameter, the name of the input file.
```php
/**
...
This information may be useful to decide if the file should be splitt
into smaller blocks.
```php
/**
...
Iterating over the [records](copernica-docs:Mailerq/record) stored in
