...
Yothalot is an C++ application for running parallel map/reduce algorithms on big 
...
However, you prefer speed over simplicity, Yothalot also comes with a C++ API. With this
