...
After having implemented your [mapreduce](Yothalot/cpp-mapreduce "MapReduce")
...
```
You first initialize the class with your [mapreduce](Yothalot/cpp-mapreduce "MapReduce")
...
program, and some data. In case of the example [MapReduce](Yothalot/cpp-mapreduce "MapReduce") this yields:
```bash
...
See [Starting a Yothalot job](Yothalot/cpp-start "Start up a job") for more detailed information on running jobs.
...
[Yothalot::Fullname](Yothalot/cpp-fullname "Fullname")
...
Yet, there is one issue that [Yothalot::Fullname](Yothalot/cpp-fullname "Fullname")
