...
with [input](Yothalot/cpp-input). Note that for working 
...
type uint32_t. The fields are all of type [Yothalot::Scalar](Yothalot/cpp-scalar "Scalar")
...
[Yothalot::Input object](Yothalot/cpp-input "Input"). The
...
## Member add()
With the add member it is possible to add a [Yothalot::Scalar](Yothalot/cpp-scalar) to
