...
* [Injecting/sending email](send-email "Send email with MailerQ")
    ...
    * [Publish raw JSON to REST API](rest-injection "Publish raw JSON to REST API")
...
* [REST API](rest-api-v1 "REST API")
    *   [Authentication](rest-api-v1#authentication "Authentication")
    *   [Pauses](rest-api-v1#pauses "Pauses")
    *   [Errors](rest-api-v1#errors "Errors")
    *   [Injection](rest-api-v1#injection "Injection")
