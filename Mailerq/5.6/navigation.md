...
* [REST API](rest-api-v1 "REST API")
    * [Inject (since 5.6.3+)](rest-api-v1-inject "Publish raw JSON to REST API")
    * [Pauses (since 5.6.3+)](rest-api-v1-pauses "Pause delivery flow")
    * [Errors (since 5.6.4+)](rest-api-v1-errors "Stop delivery flow")
