...
This function starts a timer. When the given time runs out, the callback will be invoked, unless the timer is stopped first with [MQ_stopTimer](mq_timerstop).
